...
- Transfer exported artifacts/tables to a local workstation for downstream R analysis: table cleanup, ASV renaming, diversity, composition plots, differential abundance, and manuscript figures.
